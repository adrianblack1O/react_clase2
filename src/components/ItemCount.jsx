...
const ItemCount = ({id, item, precio, stock}) => {
	...
	const [cartq, setCarr] = useState(0)
	...
	return(
		<>
  					<div className="col s6">
						...
						<div className="row">
						<button className="col s12 black-text btn-flat white lighten-2" onClick={()=> {itemq.ItemAdd({id, item, precio, cartq}); setCounter(0);}} disabled={(cartq === 0? true: false)}>+agregar al carrito</button>
						</div>
						<div className="row">
						{itemq.cart.length !== 0 &&
